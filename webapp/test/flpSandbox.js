		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#brcomlkp{{appNamespace}}-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomlkp{{appNamespace}}-display": {
								"semanticObject": "brcomlkp{{appNamespace}}",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.lkp.{{appNamespace}}",
									"url": sap.ui.require.toUrl("br/com/lkp/{{appNamespace}}")
								}
							}
						}
					}
